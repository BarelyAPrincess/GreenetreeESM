 ...
 */
public final class Codec extends ChannelHandlerAppender implements HttpClientUpgradeHandler.SourceCodec
{
	 ...
	 * ({@code maxInitialLineLength (4096} , {@code maxHeaderSize (8192)}, and {@code maxChunkSize (8192)}).
	 */
	public Codec()
	{
	 ...
	 */
	public Codec( int maxInitialLineLength, int maxHeaderSize, int maxChunkSize )
	{
	 ...
	 * Creates a new instance with the specified decoder options.
	 */
	public Codec( int maxInitialLineLength, int maxHeaderSize, int maxChunkSize, boolean failOnMissingResponse )
	{
	 ...
	 * Creates a new instance with the specified decoder options.
	 */
	public Codec( int maxInitialLineLength, int maxHeaderSize, int maxChunkSize, boolean failOnMissingResponse, boolean validateHeaders )
	{
